          ...
          <div className="flex flex-col basis-1/4 gap-4">
            ...
            >
              <div className="flex flex-col gap-1.5 p-3">
                ...
                <button
                  onClick={() => {
                    // TODO: Call reel generation API
                    router.push('/create-reel');
                  }}
                  className="w-full mt-2 px-3 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white rounded-lg text-sm font-medium flex items-center justify-center gap-2 transition-all"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                  </svg>
                  Create Reel from Chat
                </button>
